    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            if (!unavailableSeats.isEmpty()) {
                Toast.makeText(this, "Một số ghế đã được đặt: " + formatSeats(unavailableSeats), Toast.LENGTH_SHORT)
                        .show();
                bookedSeats.clear();
                bookedSeats.addAll(db.ticketDao().getBookedSeatsByShowtime(showtimeId));
            ...
            Toast.makeText(this, "Đặt " + selectedSeats.size() + " vé thành công", Toast.LENGTH_SHORT).show();
